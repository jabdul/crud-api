...
exports.server = async ({ dbConnect, schema, serverOptions, config, configOptions, configFiles = [], routes, services, plugins, postRegisterHook, swaggerOptions, swaggerUiOptions, loggerOptions, }) => await server_1.default({
    dbConnect,
    schema,
    serverOptions,

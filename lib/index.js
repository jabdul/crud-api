...
const server = ({ dbConnect, schema, serverOptions, config, configOptions, configFiles = [], routes, services, plugins, postRegisterHook, swaggerOptions, loggerOptions, dockerized = false, intializers = [], configObject = null, }) => (0, server_1.default)({
    dbConnect,
    schema,
    serverOptions,
    config: (0, config_1.default)(config, configFiles, configOptions, configObject),
    routes,
    services,
    plugins,
    postRegisterHook,

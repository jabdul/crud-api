...
exports.default = async function start(_ref) {
  ...
  var tls = {
    ...
    ca: _fs2.default.readFileSync(_path2.default.resolve(__dirname, config.get('server.tlsCa')))
  };
  ...
  await app.register([_inert2.default, _vision2.default, { plugin: _hapiSwaggered2.default, options: swaggerOptions }, { plugin: _hapiSwaggeredUi2.default, options: swaggerUiOptions }]);

...
exports.default = async ({ dbConnect, schema, config, routes, services, plugins = [], postRegisterHook, swaggerOptions = {}, loggerOptions = {}, serverOptions = {}, }) => {
    ...
    const app = new hapi_1.Server(Object.assign({ host: config.get('server.hostname'), port: config.get('server.port'), tls, debug: {

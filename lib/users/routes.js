...
exports.ROUTE_NAME = void 0;
exports.ROUTE_NAME = 'users';
const options = {
    log: { collect: true },
    auth: false,
};
exports.default = ({ services, config, validate, json }) => ({
    method: 'POST',
    path: `/${exports.ROUTE_NAME}`,
    options: Object.assign(Object.assign({}, options), { validate: {
    ...
    handler: async (request, h) => {
        ...
        return h
            .response(await services[exports.ROUTE_NAME].create({

...
exports.conf = Object.assign({ env: {
...
const convictLoader = ({ appConfig = null, base = null, configFiles = null, options = {}, configObject = null, }) => {
    const mergedConfig = Object.assign(Object.assign({}, (appConfig || {})), (base || {}));
    const configurator = configObject.load || convict_1.default;
    const config = configurator(mergedConfig).load(options);
    return configFiles ? config.loadFile(configFiles) : config;
};
const loadConfig = (appConfig = {}, configFiles, options = {}, configObject = null) => convictLoader({
    appConfig,
    configFiles,
    base: exports.conf,
    options,

...
exports.baseConfig = exports.conf = undefined;
...
var loadConfig = function loadConfig() {
  ...
  var configFiles = arguments[1];
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

  var config = (0, _convict2.default)((0, _extends3.default)({}, conf, appConfig)).load(options);
  return configFiles ? config.loadFile(configFiles) : config;
};

var baseConfig = exports.baseConfig = loadConfig();
